...
export default function ContactForm({onSubmit}: {onSubmit: (event: React.FormEvent<HTMLFormElement>) => void})
{
    ...
    return (
        <form onSubmit={onSubmit} className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48" autoComplete="off">
