            ...
            <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                ...
                <div className="mt-8 flex w-full items-center justify-between cursor-default select-none">
                    <ul className="text-sm">
                        ...
                        >
                            {nameValidState ? (
                                <CheckCircleIcon className="inline size-5" />
                            ) : (
                                <XCircleIcon className="inline size-5" />
                            )}{" "}
                            name required.
                        </li>
                        <li
                            className={`${emailValidState || phoneNumberValidState ? "text-green-500/80" : "text-red-500/80"}`}
                        >
                        ...
                        <li
                            className={`${messageValidState ? "text-green-500/80" : "text-red-500/80"}`}
                        >
                            {messageValidState ? (
                                <CheckCircleIcon className="inline size-5" />
                            ) : (
