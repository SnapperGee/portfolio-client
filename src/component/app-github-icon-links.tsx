...
(
    <div className={classes ? classes : ""}>
    {
        app
        ? <>
            <a href={app} className="flex items-center text-gray-300 hover:text-gray-100 hover:scale-105 active:scale-100">
                <PlayCircleIcon className={`h-${height}`} />
                <p className="ms-1">App</p>
            </a>
            <a href={github} className="flex items-center text-gray-300 hover:text-gray-100 hover:scale-105 active:scale-100">
